...
define(
    ...
    ['require', 'flight/lib/component', 'flight/lib/compose'],

    function (require, defineComponent, compose) {
        ...
        function withAttach() {
            ...
            var _componentOptionsRegexp: RegExp,
                _this: FlightAttachComponent;
            ...
            this.attach = function (el: HTMLElement) {

                var componentNames = el.getAttribute(this.attr.componentNameAttr).split(','),
